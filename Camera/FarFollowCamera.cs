...
{
    public class FarFollowCamera : ICamera
    {
        ...
        Matrix m_FarFollowCamera;
        public Matrix CameraMatrix
        {
            get { return m_FarFollowCamera; }
        }
        public Matrix GetCameraMatrix() {
            return this.m_FarFollowCamera;
        }
       ...
       public void ComputeMatrix()
        {
            ...
            //Create matrix
            m_FarFollowCamera = Matrix.CreateLookAt(vCamera_Pos, vTarget_Pos, vCamera_Up);
