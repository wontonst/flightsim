...
namespace itp380
{
	...
	public class GraphicsManager : itp380.Patterns.Singleton<GraphicsManager>
	{
		...
		{
			Projection = Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(85.0f), fAspectRatio, 0.01f, 10000000.0f);
            //Projection = Matrix.CreateOrthographic(m_fZoom, m_fZoom / fAspectRatio, 0.1f, 10000.0f);
		}
