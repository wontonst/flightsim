...
namespace Henge3D.Physics
{
	...
	public class RigidBody
	{
		...
		internal void IntegrateForce(float dt) {
           ////// System.Diagnostics.Debug.WriteLine("rigidbody " + this.IsActive + " Movable " + this._isMovable);
			if (this.IsActive)
			{
				Vector3 v;
		...
		private void InitializeFromModel(RigidBodyModel model)
		{
            ...
            //System.Diagnostics.Debug.WriteLine("new model with mass " + model.MassProperties.Mass);
