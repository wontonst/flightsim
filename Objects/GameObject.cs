...
namespace itp380
{
	public class GameObject
	{
        ...
        Vector3 m_vUp = Vector3.Zero;
        public Vector3 Up
        {
            get { return m_vUp; }
            set { m_vUp = value; m_bTransformDirty = true; }
        }
        ...
        public Vector3 Forward
        {
            ...
            set { m_vForward = value; m_bTransformDirty = true; }
        }
		...
		public GameObject(Game game) : base()
		{
			m_Game = game;
		}
		...
		{
            //update position
            Position += Velocity * fDeltaTime; //x = v*t  Physics!
